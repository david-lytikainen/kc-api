...
CREATE INDEX IF NOT EXISTS ix_commission_requests_status ON commission_requests (status);
...
CREATE INDEX IF NOT EXISTS ix_commission_comments_author_role ON commission_comments (author_role);
